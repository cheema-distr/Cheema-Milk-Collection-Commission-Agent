      ...
      {!selectedDriverId ? (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4"> <div> <h1 className="text-2xl font-black text-slate-800 flex items-center gap-2"> <Wallet className="w-7 h-7 text-indigo-650" />
                👑 Admin - Driver + 3RD Party Transaction
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-slate-850 to-slate-900 bg-slate-900 border border-slate-800 rounded-2xl text-white p-6 shadow-sm"> <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest font-mono mb-4">
            ...
            </h3> <div className="grid grid-cols-2 md:grid-cols-6 gap-4 items-center"> <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center"> <span className="block text-[9px] text-slate-400 uppercase">Opening Bal</span> <strong className="text-sm font-bold font-mono block mt-1">Rs. {(activeDriver?.openingBalance || 0).toLocaleString()}</strong> </div> <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 text-center"> <span className="block text-[9px] text-blue-300 uppercase">3RD Party Txn (+)</span> <strong className="text-sm font-bold font-mono text-blue-400 block mt-1">Rs. {activeDriverBalanceObj.totalAdvance.toLocaleString()}</strong> </div> <div className="bg-rose-500/10 border border-rose-500/20 rounded-xl p-4 text-center"> <span className="block text-[9px] text-rose-300 uppercase">Expenses (-)</span> <strong className="text-sm font-bold font-mono text-rose-400 block mt-1">Rs. {activeDriverBalanceObj.totalExpense.toLocaleString()}</strong> </div> <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-center"> <span className="block text-[9px] text-emerald-300 uppercase">Trip Income (+)</span> <strong className="text-sm font-bold font-mono text-emerald-400 block mt-1">Rs. {activeDriverBalanceObj.totalIncome.toLocaleString()}</strong> </div> <div className="bg-slate-500/10 border border-slate-500/20 rounded-xl p-4 text-center"> <span className="block text-[9px] text-slate-300 uppercase">Cash Returned (-)</span> <strong className="text-sm font-bold font-mono text-slate-400 block mt-1">Rs. {(activeDriverBalanceObj.totalReturn || 0).toLocaleString()}</strong> </div> <div className={`col-span-2 md:col-span-1 rounded-xl p-4 text-center ${
