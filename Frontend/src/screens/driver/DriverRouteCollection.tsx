            ...
            <div> <label className="block text-sm font-semibold text-slate-700 mb-1">Date</label> <div className="relative"> <Calendar className="w-4 h-4 absolute left-3 top-2.5 text-slate-400" /> <input 
              ...
              /> </div> </div> <div className="mb-6"> <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4"> <div className="flex flex-wrap items-center gap-2.5"> <h4 className="font-bold text-slate-800 text-sm">Collection Locations & Quality Log</h4> </div> <button type="button" onClick={addEmptyStop} className="text-indigo-600 font-medium flex items-center text-sm bg-indigo-50 px-3 py-1.5 rounded-md hover:bg-indigo-100"> <Plus className="w-4 h-4 mr-1" /> Add Row
                  ...
                  {formData.stops.map((stop, index) => (<tr 
                    ...
                    > <td className="px-1 py-1 border-r border-slate-200 text-center cursor-move text-slate-400 hover:text-indigo-600 transition-colors"> <GripVertical className="w-3.5 h-3.5 mx-auto" /> </td> <td className="px-2 py-1 border-r border-slate-200 font-medium text-slate-500">{index + 1}</td> <td className="px-1 py-1 border-r border-slate-200"> <input type="text" placeholder="customer name" value={stop.locationName} onChange={e => handleStopChange(index, 'locationName', e.target.value)} className="w-full bg-transparent border border-transparent hover:border-slate-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1 text-xs font-medium text-slate-800 focus:outline-none text-left" /> </td> <td className="px-1 py-1 border-r border-slate-200"> <input type="time" value={stop.time || ''} onChange={e => handleStopChange(index, 'time', e.target.value)} className="w-full bg-transparent border border-transparent hover:border-slate-300 focus:border-indigo-500 focus:bg-white rounded px-1 py-1 text-xs focus:outline-none" /> </td> <td className="px-1 py-1 border-r border-indigo-100 bg-indigo-50/30"> <input type="number" placeholder="KGs" value={stop.milkKgs || ''} onChange={e => handleStopChange(index, 'milkKgs', e.target.value)} className="w-full min-w-[88px] bg-transparent border border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1.5 text-sm text-center focus:outline-none font-medium" /> </td> <td className="px-1 py-1 border-r border-indigo-250 bg-indigo-100 font-bold text-indigo-950"> <input type="number" step="0.01" placeholder="Liters" value={stop.milkLiter || ''} onChange={e => handleStopChange(index, 'milkLiter', e.target.value)} className="w-full min-w-[88px] bg-transparent border border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1.5 text-sm text-center focus:outline-none font-extrabold text-indigo-950" /> </td> <td className="px-1 py-1 border-r border-indigo-100 bg-indigo-50/30"> <input type="number" step="0.01" placeholder="Fat" value={stop.fat || ''} onChange={e => handleStopChange(index, 'fat', e.target.value)} className="w-full min-w-[78px] bg-transparent border border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1.5 text-sm text-center focus:outline-none" /> </td> <td className="px-1 py-1 border-r border-indigo-100 bg-indigo-50/30"> <input type="number" step="0.01" placeholder="LR" value={stop.lr || ''} onChange={e => handleStopChange(index, 'lr', e.target.value)} className="w-full min-w-[78px] bg-transparent border border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1.5 text-sm text-center focus:outline-none" /> </td> <td className="px-1 py-1 border-r border-indigo-100 bg-indigo-50/30"> <input type="number" placeholder="°C" value={stop.temperature || ''} onChange={e => handleStopChange(index, 'temperature', e.target.value)} className="w-full min-w-[78px] bg-transparent border border-transparent hover:border-indigo-300 focus:border-indigo-500 focus:bg-white rounded px-2 py-1.5 text-sm text-center focus:outline-none" /> </td> <td className="px-2 py-1 border-r border-indigo-200 bg-indigo-100/30 font-medium text-indigo-900">{stop.snf || '-'}</td> <td className="px-2 py-1 border-r border-indigo-200 bg-indigo-100/30 font-medium text-indigo-900">{stop.totalSolids || '-'}</td> <td className="px-2 py-1 border-r border-indigo-200 bg-indigo-100/30 font-bold text-indigo-700">{stop.ts13 || '-'}</td> <td className="px-2 py-1 text-center font-bold"> <button onClick={() => removeStop(stop.id)} className="text-red-400 hover:text-red-600 p-1 rounded hover:bg-red-50 transition-colors"><Trash2 className="w-4 h-4"/></button> </td></tr>
                  ))}</tbody><tfoot>
                  {(() => {
            ...
            {(() => {
              ...
              return (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Total Locations</span><span className="font-bold text-amber-900">{summary.totalLocations}</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Total Liters</span><span className="font-bold text-amber-900">{summary.totalMilkLiter} L</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Total KGs</span><span className="font-bold text-amber-900">{summary.totalMilkKgs} KG</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Avg Fat</span><span className="font-bold text-amber-900">{summary.avgFat}%</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Avg LR</span><span className="font-bold text-amber-900">{summary.avgLr}</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Avg SNF %</span><span className="font-bold text-amber-900">{summary.avgSnf}%</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Avg TS %</span><span className="font-bold text-amber-900">{summary.avgTsPercent}%</span></div>
                  <div><span className="text-amber-800 font-semibold block uppercase text-xs mb-0.5">Total TS</span><span className="font-bold text-amber-900">{summary.totalTS13}</span></div>
                </div>
              );
            })()}
