...
export default function App() {
  ...
  return (
    <ThemeProvider> <AuthProvider> <UserProvider> <VehicleProvider> <TransactionProvider> <MilkTransactionProvider> <AccountProvider> <RouteProvider> <RouteCollectionProvider> <AdvanceProvider> <DispatchProvider>
